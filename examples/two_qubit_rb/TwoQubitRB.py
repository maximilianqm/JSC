...
class TwoQubitRb:
    ...
    def _gen_qua_program(self, sequence_depths: list[int], num_repeats: int, num_averages: int,
                         prep_args: list = None,
    ...
    def _insert_all_input_stream(self, job, sequence_depths, num_repeats):
        for sequence_depth in sequence_depths:
            for repeat in range(num_repeats):
                ...
                job.insert_input_stream('two_qubits_gates_is', self._decode_sequence_for_channel("two_qubit_gates", sequence))
    ...
    def run(self,
        ...
        prog = self._gen_qua_program(sequence_depths, num_repeats, num_averages, prep_args, prep_kwargs, measure_args,
                                     measure_kwargs)
